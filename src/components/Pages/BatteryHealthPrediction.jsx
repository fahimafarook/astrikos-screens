...
import SocIcon from "../../assets/svg/chartIcons/StateOfCharge.svg"
import SohIcon from "../../assets/svg/chartIcons/StateOfHealth.svg"
      ...
      <div className='bh-left-panel'>
        <div className='page-sub-header'>
          <div className='psh-text'>
            <div className='psh-title'>Battery Health Overview</div>
        ...
        <div className='bh-grid-container'>
          ...
          <div className='bh-grid-advisories'>
...
export default BatteryHealthPrediction
